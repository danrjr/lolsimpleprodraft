...
const Champion = () => {
    ...
    const seeIndex = (champ) => {
        ...
        if (currentBanRound === 0) {
            newBanBlueSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanBlueSide(newBanBlueSide);
        } else if (currentBanRound === 1) {
            newBanRedSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanRedSide(newBanRedSide);
        } else if (currentBanRound === 2) {
            newBanBlueSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanBlueSide(newBanBlueSide);
        } else if (currentBanRound === 3) {
            newBanRedSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanRedSide(newBanRedSide);
        } else if (currentBanRound === 4) {
            newBanBlueSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanBlueSide(newBanBlueSide);
        } else if (currentBanRound === 5) {
            newBanRedSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanRedSide(newBanRedSide);
        } else if (currentBanRound === 6) {
            newPickBlueSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickBlueSide(newPickBlueSide);
        } else if (currentBanRound === 7) {
            newPickRedSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickRedSide(newPickRedSide);
        } else if (currentBanRound === 8) {
            newPickRedSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickRedSide(newPickRedSide);
        } else if (currentBanRound === 9) {
            newPickBlueSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickBlueSide(newPickBlueSide);
        } else if (currentBanRound === 10) {
            newPickBlueSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickBlueSide(newPickBlueSide);
        } else if (currentBanRound === 11) {
            newPickRedSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickRedSide(newPickRedSide);
        } else if (currentBanRound === 12) {
            newBanRedSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanRedSide(newBanRedSide);
        } else if (currentBanRound === 13) {
            newBanBlueSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanBlueSide(newBanBlueSide);
        } else if (currentBanRound === 14) {
            newBanRedSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanRedSide(newBanRedSide);
        } else if (currentBanRound === 15) {
            newBanBlueSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setBanBlueSide(newBanBlueSide);
        } else if (currentBanRound === 16) {
            newPickRedSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickRedSide(newPickRedSide);
        } else if (currentBanRound === 17) {
            newPickBlueSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickBlueSide(newPickBlueSide);
        } else if (currentBanRound === 18) {
            newPickBlueSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickBlueSide(newPickBlueSide);
        } else if (currentBanRound === 19) {
            newPickRedSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`;
            setPickRedSide(newPickRedSide);
        }
    };
    ...
    const confirmSelection = () => {
        if (temporarySelection) {
            ...
            if (currentBanRound === 0) {
                newBanBlueSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanBlueSide(newBanBlueSide);
            } else if (currentBanRound === 1) {
                newBanRedSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanRedSide(newBanRedSide);
            } else if (currentBanRound === 2) {
                newBanBlueSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanBlueSide(newBanBlueSide);
            } else if (currentBanRound === 3) {
                newBanRedSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanRedSide(newBanRedSide);
            } else if (currentBanRound === 4) {
                newBanBlueSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanBlueSide(newBanBlueSide);
            } else if (currentBanRound === 5) {
                newBanRedSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanRedSide(newBanRedSide);
            } else if (currentBanRound === 6) {
                newPickBlueSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickBlueSide(newPickBlueSide);
            } else if (currentBanRound === 7) {
                newPickRedSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickRedSide(newPickRedSide);
            } else if (currentBanRound === 8) {
                newPickRedSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickRedSide(newPickRedSide);
            } else if (currentBanRound === 9) {
                newPickBlueSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickBlueSide(newPickBlueSide);
            } else if (currentBanRound === 10) {
                newPickBlueSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickBlueSide(newPickBlueSide);
            } else if (currentBanRound === 11) {
                newPickRedSide[2] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickRedSide(newPickRedSide);
            } else if (currentBanRound === 12) {
                newBanRedSide[1] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanRedSide(newBanRedSide);
            } else if (currentBanRound === 13) {
                newBanBlueSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanBlueSide(newBanBlueSide);
            } else if (currentBanRound === 14) {
                newBanRedSide[0] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanRedSide(newBanRedSide);
            } else if (currentBanRound === 15) {
                newBanBlueSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setBanBlueSide(newBanBlueSide);
            } else if (currentBanRound === 16) {
                newPickRedSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickRedSide(newPickRedSide);
            } else if (currentBanRound === 17) {
                newPickBlueSide[3] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickBlueSide(newPickBlueSide);
            } else if (currentBanRound === 18) {
                newPickBlueSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickBlueSide(newPickBlueSide);
            } else if (currentBanRound === 19) {
                newPickRedSide[4] = `https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${temporarySelection.name}.png`;
                setPickRedSide(newPickRedSide);
            }
            ...
            <div className="pick_container">
                ...
                <div className="champion_imgs">
                    {filteredChampions && filteredChampions.map((champ, index) => (
                        <div key={champ.id}>
                            <img 
                                src={`https://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${champ.name}.png`} 
